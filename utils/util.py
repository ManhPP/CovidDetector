...
from models.model import CovidNet
...
def load_checkpoint(checkpoint, model, strict=True, optimizer=None, load_seperate_layers=False):
    ...
    if (not load_seperate_layers):
        # models.load_state_dict(checkpoint1['model_dict'] , strict=strict)p
...
def get_arguments():
    ...
    parser.add_argument('--models', type=str, default='mobilenet_v2',
